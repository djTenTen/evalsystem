    ...
    <div class="container container-fluid">
        ...
        <div class="row">
            <div class="form-group col-lg-4">
                ...
                <input name="course" type="text" value="<?= $strand;?>" class="form-control form-control-sm" placeholder="Course" id="course" readonly>
            </div>
        ...
        <a href="<?= base_url();?>seniorhigh" class="btn btn-sm btn-success">Done</a>
                        ...
                        <div class="modal fade" id="myModaldrop<?= $subjects['studentsubjectID']?>">
                            <div class="modal-dialog modal-md">
                                <div class="modal-content">
                                    ...
                                    <?= form_open('dropsubject_seniorhigh/'.$subjects['studentsubjectID']);?>
