    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="form-group col-lg-2">
                ...
                <input name="dpt" type="text" value="<?= $level;?>" class="form-control form-control-sm" placeholder="Department" id="dpt" readonly>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                <div style="overflow-y:scroll;width:100%;height:550px">
                    ...
                    <table class="table table-bordered table-striped" style="margin-top: 1%;">
                        <tbody>
                        <?php foreach($otherSeniorhighMisc as $subjects){?>
                            <tr>
                    ...
                    <div class="modal fade" id="myModalAsses">
                        <div class="modal-dialog modal-md">
                            <div class="modal-content">
                                ...
                                <?= form_open('assesstudentSeniorhigh/'.$admissionID);?>
                                    <!-- <br>
                                    <br>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="discount" class="form-control form-control-sm" required>                                                       
                                            <?php foreach($discounts as $disc){?>
                                                <option value="<?= $disc['discountPercent'];?>"><?= $disc['discountName'].'  ('.$disc['discountPercent'].'% discount)';?></option>
                                            <?php }?>
                                        </select>
                                    </div>
                                </div>
