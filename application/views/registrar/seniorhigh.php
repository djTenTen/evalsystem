<div class="container-fluid">
    ...
    <?php
        ...
        if($this->session->flashdata('SeniorhighShifted') != null){
    ...
    <div class="container container-fluid"style="margin-top: 2%">
        ...
        <?= form_open("seniorhigh");?>
            <div class="input-group mb-3">
                <input name="searchseniorhigh" type="text" class="form-control" placeholder="Search Admission Number/Student Number/Lastname/Firstname" aria-label="Recipient's username" aria-describedby="basic-addon2">
                ...
                <?php foreach($seniorhighstudents as $row){?>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php }else{?>
                                <div class="btn-group btn-group-sm">
                                    <?= form_open('assesSeniorhigh/'.$row['admissionID']);?>
                                    ...
                                    <form action="<?= 'studentSubjectSeniorhigh/'.$row['admissionID'];?>" target="_blank">
                                    ...
                                    <?//= form_open('studentSubjectSeniorhigh/'.$row['admissionID']);?>
                                        <!-- <button type="submit"  class="btn btn-sm btn-outline-success" data-toggle="tooltip" title="Print"><span class="fas fa-print"></span></button> -->
                                    <?//= form_close();?>
                                    ...
                                    <?= form_open('seniorhigh_dropsubject/'.$row['admissionID']);?>
                            ...
                            <div class="modal fade" id="printgrade<?= $row['admissionID'];?>">
                                <div class="modal-dialog modal-md">
                                    <div class="modal-content">
                                        ...
                                        <!-- Modal body -->
                                        <?= form_open('printgradeSeniorhigh/'.$row['admissionID']);?>
                            ...
                            <div class="modal fade" id="myModalEdit<?= $row['admissionID'];?>">
                                        <div class="modal-dialog modal-xl">
                                            <div class="modal-content">
                                                ...
                                                <!-- Modal body -->
                                                <?= form_open('updateSeniorhighinfo/'.$row['admissionID']);?>
                                                    <div class="modal-body">
