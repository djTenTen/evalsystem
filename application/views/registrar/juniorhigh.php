    ...
    <div class="container container-fluid"style="margin-top: 2%">
        ...
        <?= form_open("juniorhigh");?>
            <div class="input-group mb-3">
                <input name="searchjuniorhigh" type="text" class="form-control" placeholder="Search Admission Number/Student Number/Lastname/Firstname" aria-label="Recipient's username" aria-describedby="basic-addon2">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group btn-group-sm">
                                <?= form_open('assesJuniorhigh/'.$row['admissionID']);?>
                                ...
                                <?= form_open('studentSubjectJuniorhigh/'.$row['admissionID']);?>
                            ...
                            <div class="modal fade" id="printgrade<?= $row['admissionID'];?>">
                                <div class="modal-dialog modal-md">
                                    <div class="modal-content">
                                        ...
                                        <!-- Modal body -->
                                        <?= form_open('printgradeJuniorhigh/'.$row['admissionID']);?>
                            ...
                            <div class="modal fade" id="myModalShift<?= $row['admissionID'];?>">
                                <div class="modal-dialog modal-md">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <?= form_open("shiftstudentJuniorhigh/".$row['admissionID']);?>
                            ...
                            <div class="modal fade" id="myModalEdit<?= $row['admissionID'];?>">
                                        <div class="modal-dialog modal-xl">
                                            <div class="modal-content">
                                                ...
                                                <!-- Modal body -->
                                                <?= form_open('updateJuniorhighinfo/'.$row['admissionID']);?>
                                                    <div class="modal-body">
