...
$pdf->AddPage();
        ...
        <table border="1">
            <thead>
                <tr>
                    ...
                    <th style="width: 5%;text-align: center;font-weight: bold;">Lec</th>
                    <th style="width: 5%;text-align: center;font-weight: bold;">Lab</th>
                    <th style="width: 7%;text-align: center;font-weight: bold;">Units</th>
                </tr>
            </thead>
            <tbody>           
        ';
        ...
        foreach($studentSubjects as $row){
            $lab = $row['labComputer'] + $row['labNonComputer'];
           
            $html .= '<tr>
                <td style="width: 11%;"> '.$row['subjectCode'].'</td>
                <td style="width: 40%;"> '.$row['SubjectDesc'].' - ( '.$row['CourseCode'].' '. $row['Section'].')</td>
                <td style="width: 11%; text-align: center;"> '.$row['Day'].'</td>
                <td style="width: 10%; text-align: center;"> '.$row['Time'].'</td>
                <td style="width: 11%; text-align: center; font-size: 8px"> '.$row['FullName'].'</td>
                <td style="width: 5%; text-align: center;"> '.$row['lec'].'</td>
                <td style="width: 5%; text-align: center;"> '.$lab.'</td>
                <td style="width: 7%; text-align: center;"> '.$row['computeunits'].'</td>
            </tr>';
        }
        ...
        $html .='<table>
                    <tr>
                        ...
                        <td><strong>Total Units: </strong>'.$mainunits.'</td>
                    </tr>
                </table>';
                            ...
                            <tbody> ';
                                ...
                                foreach($miscellaneousCollege as $row){
                                    $html .= '<tr>
                                        ...
                                        <td style="width: 30%;text-align: right;"> '.number_format($row['Amount'], 2, ".", ",").' </td>
                                    </tr>';
                                }
                                ...
                                $totaldiscount = $totalfee * $discount;
                                $masterTotal = $totalasses - $totaldiscount;


                                if($mp == 'Installment'){
                                    $monthly = ($masterTotal - $dp) / 4;
                                }else{
                                    $monthly = 0;
                                }
