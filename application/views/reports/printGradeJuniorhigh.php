...
$pdf->AddPage();
        ...
        $html = '
            ...
            <table>
                <tr>
                    ...
                    <td><h3>JUNIOR HIGH DEPARTMENT</h3></td>
                </tr>
            </table><br>
        ...
        $html .= ' <tr>
                ...
                <th style="text-align: center;font-weight: bold;">'.round($aq1).'</th>
                <th style="text-align: center;font-weight: bold;">'.round($aq2).'</th>
                <th style="text-align: center;font-weight: bold;">'.round($aq3).'</th>
                <th style="text-align: center;font-weight: bold;">'.round($aq4).'</th>
