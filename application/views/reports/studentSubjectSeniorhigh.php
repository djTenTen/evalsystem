...
$pdf->AddPage();
        ...
        <table border="1">
            <thead>
                <tr>
                    ...
                    <th style="width: 33%;text-align: center;font-weight: bold;">Subject Description</th>
                    <th style="width: 7%;text-align: center;font-weight: bold;">Hours</th>
        ...
        foreach($studentSubjects as $row){
            $html .= '<tr>
                ...
                <td style="width: 33%;"> '.$row['SubjectDesc'].' </td>
                <td style="width: 7%; text-align: center;"> '.$row['hrs'].' </td>
