            ...
            <style>        
                ...
                <body>
                    ...
                    <table>
                        ...
                        <tr>
                          <td><strong>Department: </strong>College</td>
                ...
                <table>
                    ...
                    <tr>
                        <td><strong>Highschool: </strong>'.$Highschool.'</td>
                        <td><strong>Year Graduated: </strong>'.$HSY.'</td>
                    </tr>
                    <tr>
                        <td><strong>Senior High School: </strong>'.$Seniorhighschool.'</td>
                        <td><strong>Year Graduated: </strong>'.$SSY.'</td>
                    </tr>
                    <tr>
                        <td><strong>Strand: </strong>'.$Sstrand.'</td>
                        <td></td>
                    </tr>
                    <tr>
                        <td><strong>College: </strong>'.$Collegeschool.'</td>
                        <td><strong>Year Graduated: </strong>'.$CSY.'</td>
                    </tr>
                    <tr>
                        <td><strong>Course: </strong>'.$Ccourse.'</td>
                        <td></td>
                    </tr>
                </table>
